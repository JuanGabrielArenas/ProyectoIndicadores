    ...
    class ControlTipoIndicador{
	   ...
	   var $objTipoIndicador;
        ...
        function validarIngreso(){
                ...
                $comandoSql = "SELECT * FROM tipoindicador WHERE id='$id' AND nombre='$nom'";
